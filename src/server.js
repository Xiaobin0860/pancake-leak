...
async function handleSendPacket(protobuff, packetID, kcpobj, keyBuffer) {
    ...
    switch (packetIdName) {
        ...
        case "SceneInitFinishReq":
            ...
            WorldPlayerInfoNotify.playerInfoList[0].name = "悬黎千钧(pancake)"
            ...
            ScenePlayerInfoNotify.playerInfoList[0].name = "悬黎千钧(pancake)"
            ScenePlayerInfoNotify.playerInfoList[0].onlinePlayerInfo.nickname = "悬黎千钧(pancake)"
            // To protobuffer
